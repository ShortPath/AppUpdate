...
//        startActivity(uninstallIntent);
    ...
    private void showDialog() {
        btnDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isAppInstalled(MainActivity.this, "com.haizhi.xForm")) {
                    ComponentName comp = new ComponentName("com.haizhi.xForm", "com.haizhi.xForm.MainActivity");
                    ...
                    new AlertDialog.Builder(MainActivity.this).setTitle("尚未安装牛倌家, 是否安装?").setNegativeButton("是", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Uri uri = Uri.parse("http://ngj.haizhi.com/#/app/home");
    ...
    private void openApk(Context context, String url) {
        ...
        Intent intent = this.getPackageManager().getLaunchIntentForPackage("com.haizhi.mc");
        startActivity(intent);
    }
